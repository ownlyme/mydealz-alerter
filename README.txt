...
you can change the $sound to your liking. disabling the sound entirely is not implemented, you'd need to delete line 195 which holds the command "(New-Object Media.SoundPlayer $sound).Play();" for that.
